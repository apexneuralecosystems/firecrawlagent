...
from apex import Model

# Manually merge Model metadata into Base.metadata to allow FK resolution
# This is necessary because ChatMessage (in Base) refers to User (in Model)
